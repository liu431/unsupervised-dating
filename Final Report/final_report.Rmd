---
title: "Self-marketing Approaches"
subtitle: "An Analysis of Online Dating"
...
![Optimal Number of Topics](Plots/optimaltopics.png)
...
![Top Words Associated With Each Topics](Plots/topicprop.png)
...
Below is all the source code used for this project, which is available on the GitHub repo for this project: [https://github.com/tonofshell/unsupervised-dating](https://github.com/tonofshell/unsupervised-dating)
...
```{python code = readLines(flatten_jupyter(here("Vector_Space_Model", "Topic_Model_with_Demographics.ipynb"))), echo = T, eval = F}

```

## LDA Topic modeling Code

```{r code = readLines(knitr::purl(here("Structural Topic Models", "stm-okcupid-cluster.Rmd"), documentation = 1)), echo = T, eval = F}
...
![Topic 1](Plots/topic1.png)
![Topic 2](Plots/topic2.png)
![Topic 3](Plots/topic3.png)
![Topic 4](Plots/topic4.png)
![Topic 5](Plots/topic5.png)
![Topic 6](Plots/topic6.png)
![Topic 7](Plots/topic7.png)
![Topic 8](Plots/topic8.png)
![Topic 9](Plots/topic9.png)
